      ...
      >
        ...
        >
          ...
          <a href="#" className="flex items-center gap-2 group">
            <span className={`font-display tracking-tight transition-all duration-500 ${isScrolled ? "text-xl text-foreground" : "text-2xl text-white"}`}>SIMPLYYGROW</span>
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="#contact">
              <Button
                size="sm"
                className={`rounded-full transition-all duration-500 cursor-pointer ${isScrolled ? "bg-foreground hover:bg-foreground/90 text-background px-6 h-8 text-xs font-semibold" : "bg-white hover:bg-white/90 text-black px-8 h-10 font-semibold"}`}
              >
                Book Call
              </Button>
            </a>
